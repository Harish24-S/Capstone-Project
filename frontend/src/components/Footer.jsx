...
function Footer() {
  return (
    <div className='w-full bg-slate-800'>
      <div className='grid py-20 px-5 w-[80%] grid-cols-1 sm:grid-cols-2 gap-10 md:grid-cols-4 text-white mx-auto'>
      <div>
        <p className='text-4xl mb-2'>Eduwave</p>
        <p>©Eduwave 2024 | All rights reserved.</p>
      </div>
      <div>
      ...
      <div>
        <h1 className='text-lg md:text-xl mb-2'>Resources</h1>
